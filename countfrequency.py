...
fun = pd.read_csv('C:\\Users\\DELL\\Download/Funny_split.csv')
happy = pd.read_csv('C:\\Users\\DELL\\Download/Happie_split.csv')
unsmile = pd.read_csv('C:\\Users\\DELL\\Download/Unsmile_split.csv')
sad = pd.read_csv('C:\\Users\\DELL\\Download/Sad_split.csv')

#Get the wordbag
wordbag = pd.read_csv('C:\\Users\\DELL\\Download/Wordbag.csv')
...
ftable.to_csv('C:\\Users\\DELL\\Download/Ftable.csv')
print(positive_instance)
print(negative_instance)
